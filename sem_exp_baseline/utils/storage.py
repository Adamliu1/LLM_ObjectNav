...
class RolloutStorage(object):
    ...
    def __init__(
        ...
        self.rec_states = torch.zeros(
            num_steps + 1, num_processes, rec_state_size
        )
    ...
    def feed_forward_generator(self, advantages, num_mini_batch):
        ...
        for indices in sampler:
            yield {
                ...
                "extras": (
                    self.extras[:-1].view(-1, self.extras_size)[indices]
                    if self.has_extras
                    else None
                ),
            }
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        for start_ind in range(0, num_processes, num_envs_per_batch):
            ...
            yield {
                ...
                "extras": (
                    _flatten_helper(T, N, extras) if self.has_extras else None
                ),
