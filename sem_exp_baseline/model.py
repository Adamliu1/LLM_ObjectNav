...
from sem_exp_baseline.utils.distributions import Categorical, DiagGaussian
from utils.model import get_grid, ChannelPool, Flatten, NNBase
import sem_exp_baseline.envs.utils.depth_utils as du
...
class RL_Policy(nn.Module):
    ...
    def __init__(
        self, obs_shape, action_space, model_type=0, base_kwargs=None
    ):
...
class Semantic_Mapping(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.shift_loc = [
            self.vision_range * self.resolution // 2,
            0,
            np.pi / 2.0,
        ]
