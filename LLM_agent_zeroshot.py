    ...
    for step in range(args.num_training_frames // args.num_processes + 1):
        ...
        if l_step == args.num_local_steps - 1:
            ...
            for e in range(num_scenes):
                ...
                # #### LLM frontier score
                # ------------------------------------------------------------------
                if args.llm_score_version == 1:
                    frontier_score_list = (
                        sim_context.navigation_manager.calculate_frontier_scores_no_cot(
                            e,
                            frontier_score_list,
                            sim_context.infos,
                ...
                if args.llm_score_version == 2:
                    frontier_score_list = (
                        sim_context.navigation_manager.calculate_frontier_scores_v2(
                            e,
                            frontier_score_list,
                            sim_context.infos,
                            sim_context.local_pose,
                ...
                elif args.llm_score_version == 3:
                    # this is positive + negative CoT
                    frontier_score_list = (
                        sim_context.navigation_manager.calculate_frontier_scores_v3(
                            e,
                            frontier_score_list,
                            sim_context.infos,
                            sim_context.local_pose,
                    ...
                    raise ValueError("Invalid LLM score version")
        ...
        for e in range(num_scenes):
            ...
            if len(frontier_score_list[e]) > 0:
                # take the max score of the frontier
