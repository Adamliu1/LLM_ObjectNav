...
def get_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Version of LLM score calculation",
    )

    # This is used in L3MVN default, for it's zeroshot approach
    parser.add_argument(
        "--llm_name",
        type=str,
        default="GPT2-large",
    ...
    parser.add_argument(
        "--wandb_not_log",
        action="store_true",
        help="Disable experiment trackers for logging.",
    )

    parser.add_argument(
        "--wandb_args",
        type=str,
        default="project=yadongliu_fyp,name=testrun",
    ...
    # TODO: here modified for hm3d sem 0.2
    parser.add_argument("--version", type=str, default="v2", help="dataset version")

    # Model Hyperparameters
    parser.add_argument("--agent", type=str, default="sem_exp_baseline")
    ...
    parser.add_argument(
        "--map_size_cm", type=int, default=2400
    )  # NOTE: this is sem_exp
    ...
    # TODO: I want default arg to use ground truth semantic map
    parser.add_argument("--use_gtsem", type=int, default=1)
    ...
    if args.cuda:
        if args.auto_gpu_config:
            ...
            # elif (
            #     "objectnav_gibson" in args.task_config
            #     and "train" in args.split
            # ):
            #     args.total_num_scenes = 25
            # elif (
            #     "objectnav_gibson" in args.task_config and "val" in args.split
            # ):
            ...
            #     )
            # TODO: modified here for HM3D
            if args.total_num_scenes != "auto":
                args.total_num_scenes = int(args.total_num_scenes)
            elif "objectnav_hm3d" in args.task_config and "train" in args.split:
                args.total_num_scenes = 145
            elif "objectnav_hm3d" in args.task_config and "val_mini" in args.split:
                args.total_num_scenes = 2
            elif "objectnav_hm3d" in args.task_config and "val" in args.split:
                args.total_num_scenes = 36
            else:
                assert False, (
                    "Unknown task config, please specify" + " total_num_scenes"
                )
            ...
            print(num_gpus)
            print(gpu_memory)
            print(num_processes_on_first_gpu)
            print(num_processes_per_gpu)
